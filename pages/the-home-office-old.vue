...
const { data, error } = await useAsyncData('home-office', () => queryContent('pages/the-home-office-old').findOne())
...
useSeoMeta({
  title: 'The Home Office Old | Panayiotis Georgiou | @peterpandev',
  ogTitle: 'The Home Office Old | Panayiotis Georgiou | @peterpandev',
